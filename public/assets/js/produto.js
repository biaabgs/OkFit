    ...
    .then(data => {
      ...
      const imagensPorSabor = {
        baunilha: {
          ...
          barrinha: "assets/img/suplementos/barrinha_azul.png"
        },
        chocolate: {
          whey: "assets/img/suplementos/whey_chocolate.png",
          barrinha: "assets/img/suplementos/barrinha_laranja.png"
        },
      ...
      if (selectSabores && imagemProduto) {
        selectSabores.addEventListener("change", () => {
          ...
          const tipoProduto = produto.titulo.toLowerCase().includes("barrinha") ? "barrinha" : "whey";

          if (
            saborSelecionado &&
            imagensPorSabor[saborSelecionado] &&
            imagensPorSabor[saborSelecionado][tipoProduto]
          ) {
